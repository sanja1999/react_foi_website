        ...
        <section className="SectionHero">
                <div className="SectionHero-Overlay">
                    <div className="SectionHero-Content">
                        <h1 className="SectionHero-Heading">Centar za podršku studentima i razvoj karjera</h1>
                        <p className="SectionHero-Subheading">
                            ...
                            bi se uspješno nosili s akademskim izazovima, napredovali kroz studij
                            i počeli graditi svoju karijeru već tijekom studentskih dana.
                        </p>
                    </div>
